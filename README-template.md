...
3. How to use local fonts in Vite? What is that "i" in font weight? Setup fonts
    ...
    - Setup static variables is dead simple: place them under public, declare `@font-face{}` and use by their set family name
    - `@font-face{}`'s `url format()` issue. I had to remove it
